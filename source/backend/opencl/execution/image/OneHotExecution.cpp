...
OneHotExecution::OneHotExecution(int axis, Backend *backend)
    : Execution(backend) {
  mAxis = axis;
...
ErrorCode OneHotExecution::onResize(const std::vector<Tensor *> &inputs,
...
ErrorCode OneHotExecution::onExecute(const std::vector<Tensor *> &inputs,
                                     const std::vector<Tensor *> &outputs) {
